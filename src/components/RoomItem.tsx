          ...
          <div className="space-y-3">
            ...
            {isBooked && bookingInfo ? (
              <div className="border-t pt-2 mt-2">
                <h4 className="font-semibold text-sm mb-1">Booking Details</h4>
                <div className="space-y-1 text-sm">
                  ...
                  <div className="mt-1">
                    ...
                    <div>{bookingInfo.bookedBy}</div>
                  </div>
                  <div>
                    <div className="font-medium">Purpose:</div>
                    <div>{bookingInfo.purpose}</div>
                  </div>
                </div>
              </div>
            ) : (
              <div className="border-t pt-2 mt-2">
                <p className="text-green-600 font-medium">This room is currently available for booking</p>
              </div>
            )}
          </div>
        </HoverCardContent>
